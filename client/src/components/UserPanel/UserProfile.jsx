...
import { Container, Row, Col, Card, ListGroup, Form, Button, Table, Modal, Stack } from "react-bootstrap";
...
const UserProfile = () => {
  ...
  return (
    ...
    <Row>
      <Col clasName="d-flex">
      <Card>
    <Card.Img  style={{ width: '18rem' }} variant="top" src="https://upload.wikimedia.org/wikipedia/commons/8/89/Portrait_Placeholder.png" />
    </Card>
      </Col>
      <Col>
    ...
    <Row className="d-md-none" >
      ...
      <Card.Header><h4>Mis ordenes</h4></Card.Header>
      <Card.Body>
        <Card.Text>
          Accede facilmente a las ordenes de tus compras pasadas
        </Card.Text>
        <Button variant="warning">Ir a ordenes</Button>
      </Card.Body>
    </Card></Col>
      <Col><Card style={{ width: '18rem' }} className="text-center">
      <Card.Header><h4>Editar Perfil</h4></Card.Header>
      <Card.Body>
        <Card.Text>
          Edita tu información personal para que este siempre al dia
        </Card.Text>
        <Button variant="warning">Ir a Editar Perfil</Button>
      </Card.Body>
    </Card></Col>
      <Col><Card style={{ width: '18rem' }} className="text-center">
      <Card.Header><h4>Mensajes</h4></Card.Header>
      <Card.Body>
        <Card.Text>
          Accede a los ultimos mensajes con el comprador
        </Card.Text>
        <Button variant="warning">Ir a Mensajes</Button>
      </Card.Body>
    </Card>
    </Col>
    </Row>
